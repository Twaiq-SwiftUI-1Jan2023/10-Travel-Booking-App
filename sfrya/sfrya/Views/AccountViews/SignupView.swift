...
struct SignupView: View {
    ...
    @State var confirmedPasswordInput : String = ""
        ...
        ZStack { //UI Container start
            ...
            VStack{ //content start
                ...
                VStack(spacing: 32.0){ //rectangle start
                    ...
                    VStack{ //confirm password block start
                        HStack{
                            Spacer()
                            Text("تأكيد كلمة المرور")
                        }
                        .padding(.trailing)
                        HStack{ //user confirm password input start
                            Spacer()
                            Image(systemName: "eye.slash")
                            SecureField(text:$confirmedPasswordInput,
                                        prompt:Text("تأكيد كلمة المرور")
                            ){}
                                .multilineTextAlignment(.trailing)
                            Image(systemName: "lock")
                            Spacer()
                    ...
                    } //confirm password block end
                    VStack { //signup block start
                    ...
                    VStack { //existing-account block start
                        HStack{
                    ...
                    } //existing-account block end
                    Spacer()
                    VStack { //third-party signup block start
                        HStack{
                            VStack{
