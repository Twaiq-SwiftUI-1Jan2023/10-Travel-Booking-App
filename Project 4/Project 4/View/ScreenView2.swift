        ...
        ZStack {
            ...
            VStack {
                ...
                HStack(spacing: 35) {
                    ...
                    Text("Register New Account").font(.title3).fontWeight(.semibold).multilineTextAlignment(.center)
            ...
            VStack {
                ...
                RoundedRectangle(cornerRadius: 44, style: .continuous).frame(width: UIScreen.main.bounds.width, height: UIScreen.main.bounds.height - 150, alignment: .center).foregroundColor(.white).opacity(0.55).overlay(alignment: .center) {
                    ...
                    VStack(spacing: -5) {
                        ...
                        Text("Confrim Password").padding(.leading, -170).font(.headline).fontWeight(.semibold).opacity(0.75)
                        
                        SecureField("Confirm Password", text: $confirmPassword).multilineTextAlignment(.center).font(.headline).fontWeight(.semibold).padding().border(.gray).padding().overlay() {
                        ...
                        Button {
                            ...
                            RoundedRectangle(cornerRadius: 10.0).frame(width: UIScreen.main.bounds.width - 30, height: 60, alignment: .center).foregroundColor(.primary).overlay(alignment: .center) {
                                ...
                                Text("Sign Up").font(.headline).fontWeight(.semibold).foregroundColor(.white)
                        ...
                        HStack {
                            ...
                            Text("Already have an account?").fontWeight(.regular)
                            ...
                            Button {
                                ...
                                Text("Sign In").font(.headline).fontWeight(.semibold).foregroundColor(.primary)
                        ...
                        VStack {
                            ...
                            Text("Or sign up with").font(.headline)
...
struct ScreenView2_Previews: PreviewProvider {
